...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">LeetCode Project API Docs</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            <li class="link">
                                <a href="components/Algorithms.html" data-type="entity-link" >Algorithms</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/Concurrency.html" data-type="entity-link" >Concurrency</a>
                            </li>
                            <li class="link">
                                <a href="components/Content.html" data-type="entity-link" >Content</a>
                            </li>
                            <li class="link">
                                <a href="components/DbProblemModal.html" data-type="entity-link" >DbProblemModal</a>
                            </li>
                            <li class="link">
                                <a href="components/Footer.html" data-type="entity-link" >Footer</a>
                            </li>
                            <li class="link">
                                <a href="components/Java.html" data-type="entity-link" >Java</a>
                            </li>
                            <li class="link">
                                <a href="components/Javacontent.html" data-type="entity-link" >Javacontent</a>
                            </li>
                            <li class="link">
                                <a href="components/Navbar.html" data-type="entity-link" >Navbar</a>
                            </li>
                            <li class="link">
                                <a href="components/PageLayout.html" data-type="entity-link" >PageLayout</a>
                            </li>
                            <li class="link">
                                <a href="components/Postgresql.html" data-type="entity-link" >Postgresql</a>
                            </li>
                        </ul>
                    </li>
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="injectables-links"' : 'id="xs-injectables-links"' }>
                                <li class="link">
                                    <a href="injectables/SqlFilesService.html" data-type="entity-link" >SqlFilesService</a>
                                </li>
                            </ul>
                        </li>
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            ...
                            <li class="link">
                                <a href="interfaces/SqlFile.html" data-type="entity-link" >SqlFile</a>
                            </li>
                            <li class="link">
